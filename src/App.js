...
function App() {
  ...
  //   return () => {
  //     windowSize.removeEventListener("resize", changeWindowSize);
  //   };
  // }, []);
  ...
  //         size={10}
  //         color="black"
  //         style={{ position: "absolute", left: "160px", top: "96px" }}
  //       />
  //     </div>
  ...
  return (
    <div>
      {/* <button type="button" className="btn" onClick={showMem}>
        Show Members
      </button> */}
      <FaGreaterThan
        onClick={showMem}
      ...
      />
      {modal && <Member setModal={setModal} />}
    </div>
  );
}
export default App;
